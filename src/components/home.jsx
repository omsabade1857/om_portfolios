...
import "./home.css";
import cv from '../assets/Omkar_Resume.pdf';
const Home = () => {
  ...
  return (
    <div
      name="home"
      className="pt-20 h-screen w-full bg-gradient-to-b from-black via-black to-gray-800"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-8 md:flex-row">
        <div className="flex flex-col justify-center h-full ml-auto">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            Aspiring Full Stack Engineer Seeking to Create Innovative
            Solutions..!!
          </p>
          <div>
            <button
            ...
            >
              Portfolio
              <span className="ml-2">{toggleMusicIcon()}</span>
        ...
        <div>
          <img
            src={MyImage}
            alt="my profile"
            className="rounded-full h-auto mx-auto my-auto w-3/5 md:w-3/5 sm:w-1/3"
          />
        </div>
      </div>
    </div>
