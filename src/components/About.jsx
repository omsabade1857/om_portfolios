        ...
        <div name="about" className='w-full  bg-gradient-to-b from-gray-800 to-black text-white md:h-screen '>
            <div className='max-w-screen-lg p-10 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <div className=' text-md text-justify'>
                    ...
                    <p className='mt-5 '>
                        Proficient in a range of programming languages, including Java, c++ And C#. I am well-versed in data structures,
                        algorithms, and problem-solving. I also have hands-on experience with web development technologies, such as Spring, SpringBoot, Hibernete, Asp. Net.
                        Also I am Familiar with Docker, Kubernetes, git and database
